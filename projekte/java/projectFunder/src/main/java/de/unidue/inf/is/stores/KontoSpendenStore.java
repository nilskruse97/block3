...
public class KontoSpendenStore extends AbstractStore
{
    ...
    private final String INSERT_FUND = "insert into dbp064.spenden (spender,projekt,spendenbetrag,sichbtarkeit) VALUES(?,?,?,?)";
    ...
    {
        try(PreparedStatement preparedStatement = connection.prepareStatement(INSERT_FUND))
        {
            preparedStatement.setString(1, spender);
            preparedStatement.setInt(2, projekt);
